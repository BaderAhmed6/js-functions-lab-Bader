...
console.log('Exercise 5 Result:', greetUser("Bader", "evening"));
...
const   calculateTip = (BA, TP) => {
    return BA*(TP/100); // I google the way how to calculate the tip amount if its okay :)
...
Complete the exercise in the space below:
*/
const   convertTemperature = (TEM, scale) => {
    if (scale === 'C') {
        return (TEM * 9 / 5) + 32;
    } else if (scale === 'F') {
        return (TEM - 32) * 5 / 9;
